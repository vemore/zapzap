...
- **Playable.** Home, login, register, the parties list, create-party, one party's lobby,
  ...
  missing against the React client ([[Frontend]]): the admin Parties and Statistics tabs
  (placeholders for now). Google sign-in: below, under Authentication.
