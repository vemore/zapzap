...
| Flutter client | `frontend-flutter/` | Flutter 3.47 (Dart 3.13), Provider, go_router, gen-l10n fr/en | login and register, no lobby or game yet, not deployed; Android (debug) + PWA under `/app/` |
