...
| Flutter client | `frontend-flutter/` | Flutter 3.47 (Dart 3.13), Provider, go_router, gen-l10n fr/en | login, register, the party list, create-party, the lobby and the game board; no history, stats or admin yet, not deployed; Android (debug) + PWA under `/app/` |
