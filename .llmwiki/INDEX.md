...
| [[FrontendFlutter]] | `frontend-flutter/`: the Flutter client (Android + PWA under `/app/`), lib layout, ApiConfig, API layer, real-time channel (SSE), theme, l10n fr/en, build and tests | 2026-09-22 |
