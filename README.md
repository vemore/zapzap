...
| Flutter client | `frontend-flutter/` | Flutter 3.47 (Dart 3.13), Provider, go_router, gen-l10n fr/en | login, register, the party list, create-party and the lobby, history and statistics; no game board yet; Android (debug) + PWA deployed under `/app/` |
