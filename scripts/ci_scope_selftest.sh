...
# The rollback backend: jest, its image, the parity suite; not the end-to-end run, whose
# bots `zapzap-backend seed` seeds without Node.
check "0 0 0 1 0 0 1 1 0" "src/api/bootstrap.js"
check "0 0 0 1 0 0 1 1 0" "src/domain/entities/User.js"
