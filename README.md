...
The Google Play store listing — texts and phone screenshots in the app's ten languages, icon,
feature graphic — is `store_listing/`, generated by committed scripts:
[`store_listing/README.md`](store_listing/README.md).
