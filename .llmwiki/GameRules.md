...
### Round start
- Party start: 3-8 players (`zapzap-rust/src/domain/entities/party.rs:106-108`); round 1, player index 0 starts (`zapzap-rust/src/application/party/start_party.rs:66-74`).
