...
| The Flutter end-to-end test (`frontend-flutter/integration_test/`) runs only locally | [[Testing]] | it needs a live backend with bots and a chromedriver; a CI job starting the Rust backend is its own wip entry |
