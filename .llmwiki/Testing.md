...
| Rust backend rules and bots tests (`zapzap-rust/tests/rules_and_bots_tests.rs`, 6 tests: eliminated starter, starter wrap, tied lowest hands, repeated card, concurrent bot triggers, one strategy per bot) | `cargo test --test rules_and_bots_tests` | green | yes |
